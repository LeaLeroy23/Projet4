          ...
          <div class="container-dashboard" id="dashboard">
              ...
              <div class="row row-dashboard">
                ...
                <div class="col-12 box-dashboard" id="box-dashboard">
                    ...
                    <form method="POST" action="index.php?action=dashboard" enctype="multipart/form-data">
                    <input type="hidden" name="chapter" value="add" />
                    <h4 class="title-dashboard"><i class="fas fa-pen"></i>Ecrire un Chapitre</h4>
                        <div class="col-12">
                          <input type="text" id="form-writting" name="title" placeholder="Titre" value='<?= isset($title) ? $title : '' ?>' style="height: 3.3rem;">
                          <?php if (isset($errors['title'])) { ?>
                          <p>erreur dans le titre</p>
                          <?php } ?>
